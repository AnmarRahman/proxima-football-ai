...
import { BarChart3, GitCompare, MessageSquare, Search, Target, Trophy } from "lucide-react"
...
export function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      title: "Team Analysis",
      description:
        "Complete squad breakdowns with age analysis, peak years prediction, and 3-5 year performance forecasts.",
      badge: "Advanced",
      href: "/teams",
    },
    {
      ...
      description: "Participate in polls, debates, and share AI-generated predictions on social media platforms.",
      badge: "Community",
      href: "/community",
    },
    {
      icon: Trophy,
      title: "Trophy Predictions",
      description:
        "Predict individual awards, team trophies, and career achievements using comprehensive data analysis.",
      badge: "Premium",
      href: "/trophies",
    },
  ]
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <CardContent>
                <Button
                  variant="outline"
                  className="w-full border-primary/30 hover:bg-primary/10 hover:border-primary/50 hover:text-white bg-transparent"
                  asChild
                >
